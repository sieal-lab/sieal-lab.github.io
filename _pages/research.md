...
We work at the join between Earth observation, computer vision and coastal ecology. The through-line across
everything below is the same: automating the analysis of very large image datasets so that ecosystems can be
measured at a scale fieldwork alone cannot reach.
...
<h4 class="research-title">Blue carbon stock mapping</h4>
...
<div class="research-body">
<h4 class="research-title">Blue Biodiversity Integrity Index</h4>
...
workflows for classifying seafloor imagery and detecting megabenthic fauna across the Clarion&ndash;Clipperton Zone
in the Pacific and the tropical Atlantic, working with hundreds of thousands of images collected by towed camera
systems. Those pipelines &mdash; [AI-SCW]({{ site.url }}{{ site.baseurl }}/software) for seafloor classification and
[FaunD-Fast]({{ site.url }}{{ site.baseurl }}/software) for fauna detection &mdash; are the technical foundation for
what SIEAL now applies to Kenya's coastal ecosystems. See [Publications]({{ site.url }}{{ site.baseurl }}/publications).
